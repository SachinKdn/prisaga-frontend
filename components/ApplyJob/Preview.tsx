...
const Preview = (props: Props) => {
  ...
  //   return salary * vendorPercentage / 100}, [formData?.vendorData])
    ...
    <Box sx={styles.wrapper}>
      <Box sx={styles.editSection}>
        ...
        <Box sx={styles.detailWrapper}>
          <DetailCard title="First name" value={formData?.firstName} />
          <DetailCard title="Last name" value={formData?.lastName} />
          <DetailCard title="City" value={formData?.location?.city} />
          <DetailCard title="State" value={formData?.location?.state} />
          <DetailCard title="LinkedIn" value={formData?.linkedin} />
          <DetailCard title="Website" value={formData?.website} />
          <DetailCard
            title="Area of expertise"
            value={formData?.areaOfExpertise}
          />
        </Box>
        {/* <SectionHeader title="Job Details" handleEdit={()=> setActiveSectionIndex(1)} />
        <Box sx={styles.detailWrapper}>
          <DetailCard title='Title' value={formData?.title}/>
          <DetailCard title='Openings' value={formData?.noOfOpenings}/>
          <DetailCard title='Area of expertise' value={formData?.areaOfExpertise}/>
          ...
          <DetailCard title='Minimum Experience Yr.' value={formData?.experienceFrom}/>
          <DetailCard title='Maximum Experience Yr.' value={formData?.experienceTo}/>
          <DetailCard title='Minimum Qualification' value={formData?.minQualification}/>
        </Box> */}
        {/* <SectionHeader title="Vendor Compensation" handleEdit={()=> setActiveSectionIndex(3)} />
        <Box sx={styles.detailWrapper}>
          <DetailCard title='Compensation for Lite Membership' value={formData?.vendorData?.basicFeePercentage + '%'}/>
          <DetailCard title='Compensation for Prime Membership' value={formData?.vendorData?.premiumFeePercentage + '%'}/>
          <DetailCard title='Lite Membership Billing Amount' value={'₹ ' + basicBillingAmount}/>
          <DetailCard title='Prime Membership Billing Amount' value={'₹ ' + proBillingAmount}/>
        </Box> */}
        <SectionHeader
          title="Questionnaire"
        ...
        <Box sx={styles.questionsWrapper}>
          {formData?.questionnaire?.map((QnA, index) => (
            <Box sx={styles.qna} key={index}>
              ...
              <DetailCard title={QnA.question} value={QnA.answer} />
            </Box>
          ))}
        </Box>
      </Box>
